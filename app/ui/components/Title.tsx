  ...
  return (
    <div className="mt-4 flex w-full items-center justify-between px-2 py-1">
      ...
      <div className="flex items-center justify-between gap-2">
        <SecondaryBtn onClick={() => handleScroll ? handleScroll(true) : ''}
          icon="/icons/arrow_forward.svg" className="rotate-180 pl-2 pr-1" />
        <SecondaryBtn onClick={() => handleScroll ? handleScroll(false) : ''}
          icon="/icons/arrow_forward.svg" className="pl-2 pr-1"/>
        {handleQueue ?
